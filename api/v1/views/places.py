#!/usr/bin/python3
'''This contains the places view for the API.'''
...
def get_places(city_id=None, place_id=None):
    '''this gets the place with the given id or all places in
...
def remove_place(city_id=None, place_id=None):
    '''This removes a place with the given id.
    '''
    if place_id:
        place = storage.get(Place, place_id)
        if place:
